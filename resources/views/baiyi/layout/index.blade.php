...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="{{asset('h/dynamic/style.css')}}">
              ...
              <div class="am-g">
                ...
                <div class="am-u-md-10">
                  <div class="header-right am-fr">
                    ...
                    <a href="{{url('baiyi/creator')}}" class="contact-btn">
                      <button type="button" class="am-btn am-btn-secondary am-radius">非遗创客教室</button>
                    </a>
                  </div>
                </div>
              </div>
        ...
        <div class="nav-contain">
              <div class="nav-inner">
                <ul class="am-nav am-nav-pills am-nav-justify">
                  ...
                  <li>
                    <a href="{{url('baiyi/brand')}}">品牌</a>
                    <!-- sub-menu start-->
                    <ul class="sub-menu">
                      <li class="menu-item"><a href="{{url('baiyi/brand')}}">品牌故事</a></li>
                      <li class="menu-item"><a href="{{url('baiyi/culture')}}">企业文化</a></li>
                      <li class="menu-item"><a href="{{url('baiyi/partner')}}">合作伙伴</a></li>
                    </ul>
                    <!-- sub-menu end-->
                  </li>
                      ...
                      <ul class="sub-menu">
                        <li class="menu-item">
                          <a href="{{url('baiyi/young_little')}}">小班</a>
                            <ul class="sub-menu-3">
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_little_ceramic')}}" style="padding-right: 0px;padding-left: 5px;" >陶工坊课程案例</a>
                                </li>
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_little_timber')}}" style="padding-right: 0px;padding-left: 5px;" >木工坊课程案例</a>
                                </li>
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_little_paper')}}" style="padding-right: 0px;padding-left: 5px;" >纸工坊课程案例</a>
                                </li>
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_little_farming')}}" style="padding-right: 0px;padding-left: 5px;" >农工坊课程案例</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item">
                          <a href="{{url('baiyi/young_centre')}}">中班</a>
                            <ul class="sub-menu-3">
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_centre_ceramic')}}" style="padding-right: 0px;padding-left: 5px;" >陶工坊课程案例</a>
                                </li>
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_centre_timber')}}" style="padding-right: 0px;padding-left: 5px;" >木工坊课程案例</a>
                                </li>
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_centre_paper')}}" style="padding-right: 0px;padding-left: 5px;" >纸工坊课程案例</a>
                                </li>
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_centre_farming')}}" style="padding-right: 0px;padding-left: 5px;" >农工坊课程案例</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item">
                          <a href="{{url('baiyi/young_big')}}">大班</a>
                            <ul class="sub-menu-3">
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_big_ceramic')}}" style="padding-right: 0px;padding-left: 5px;" >陶工坊课程案例</a>
                                </li>
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_big_timber')}}" style="padding-right: 0px;padding-left: 5px;" >木工坊课程案例</a>
                                </li>
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_big_paper')}}" style="padding-right: 0px;padding-left: 5px;" >纸工坊课程案例</a>
                                </li>
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_big_farming')}}" style="padding-right: 0px;padding-left: 5px;" >农工坊课程案例</a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item">
                          <a href="{{url('baiyi/young_preschool')}}">学前</a>
                            <ul class="sub-menu-3">
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_preschool_ceramic')}}" style="padding-right: 0px;padding-left: 5px;" >陶工坊课程案例</a>
                                </li>
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_preschool_timber')}}" style="padding-right: 0px;padding-left: 5px;" >木工坊课程案例</a>
                                </li>
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_preschool_paper')}}" style="padding-right: 0px;padding-left: 5px;" >纸工坊课程案例</a>
                                </li>
                                <li class="menu-item">
                                  <a href="{{url('baiyi/young_preschool_farming')}}" style="padding-right: 0px;padding-left: 5px;" >农工坊课程案例</a>
                                </li>
                            </ul>
                        </li>
                      </ul>
                        ...
                        <li class="am-parent">
                          <a href="#" class="" >百艺动态</a>
                            <ul class="am-menu-sub am-collapse ">
                                <li class="am-parent">
                                  <a href="{{url('baiyi/baiyi_dynamic')}}" class="" >百艺动态</a>
                                </li>
                            </ul>
                        </li>
                        <li class="am-parent">
              ...
              <div class="">
                <div class="footer_main--column">
                  <div class="footer-floor2">
                     <p>Copyright © 2007-2019 baiyigongfang.com. All Rights Reserved. 百艺工坊 版权所有</p>
                      <p></p>
                      <p>
                        <a href="http://www.beianbeian.com/beianxinxi/241951f38870be71932da8a2894f0535.html" target="_blank">京ICP备18036723号-1</a>
                      </p>
                    </div>
                </div>
              </div>
