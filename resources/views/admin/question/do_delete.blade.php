            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    ...
                    <div class="box-header">
                        <h2><i class="halflings-icon white align-justify"></i><span class="break">回收站</span></h2>
                    </div>

                    <div class="box-content">
                        <div class="row-fluid">
                            <form method="get" action="/admin/question/do_delete/{id}">
                                <div class="span6">
                                ...
                                <table class="table table-bordered table-striped table-condensed">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="center">{{$v['q_content']}}</td>
                                            <td class="center">{{$v['status']}}</td>
                                            <td class="center">{{$v['q_time']}}</td>
                                            <td class="text-center">
                                                <a class="btn btn-info" href="/admin/question/do_history/{{$v['id']}}">
