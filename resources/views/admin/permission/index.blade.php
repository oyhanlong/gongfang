                    ...
                    <div class="box-content">
                        <div class="row-fluid">
                                ...
                                <table class="table table-bordered table-striped table-condensed">
                                      ...
                                      @foreach($data as $k=>$v)
                                        <tr>
                                            ...
                                            <td class="center">{{$v->per_name}}</td>
                                            <td class="center">{{$v->per_description}}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="javascript:void(0)" onclick="delPermission({{$v->id}})">
                                                    删除
                                                </a>
                                            </td>
                                        </tr>
                            ...
                            <script>
                                ...
                                function delPermission(perid){

                                    layer.confirm('是否确认删除？', {
                                        btn: ['确认','取消'] //按钮
                                    }, function(){

                                        $.post('{{url('admin/permission/')}}/'+perid,{'_token':'{{csrf_token()}}','_method':'delete'},function(data){
                                            //console.log(data);
                            //                    删除成功
                                            if(data.status == 0){
