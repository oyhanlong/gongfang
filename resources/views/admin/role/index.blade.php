                                ...
                                <table class="table table-bordered table-striped table-condensed">
                                      ...
                                      @foreach($data as $k=>$v)
                                        <tr>
                                            ...
                                            <td class="center">{{$v->role_name}}</td>
                                            <td class="center">{{$v->role_description}}</td>

                                            <td class="text-center">
                                                <a href="{{url('admin/role/'.$v->id)}}">授权 |
                                                </a>
                                                <a href="{{url('admin/role/'.$v->id.'/edit')}}">
                                                   修改 |
                                                </a>

                                                <a href="javascript:void(0)" onclick="delRole({{$v->id}})">
                                                    删除
                                                </a>
                                            </td>
                                        </tr>
