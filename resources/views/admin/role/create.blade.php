    ...
    <div class="container-fluid-full">
        <div class="row-fluid">
            ...
            <div class="row-fluid sortable">
                ...
                <form class="form-horizontal" action="{{url('admin/role')}}" method="post" enctype="multipart/form-data" id="myform" >
                        {{ csrf_field() }}
                    <div class="control-group success">
                        <label class="control-label" for="role_Name">角色名</label>
                        <div class="controls">
                          <input type="text" id="role_name" name="role_name"><strong></strong>
                        </div>
                    </div>
                    <div class="control-group success">
                        <label class="control-label" for="role_description">角色描述</label>
                        <div class="controls">
                          <input type="text" id="role_description" name="role_description"><strong></strong>
                        </div>
                    </div>
