...
<div class="container-fluid-full">
    ...
    <div class="result_wrap box-content">
        <form action="{{url('admin/article')}}" id="art_form" method="post"  enctype="multipart/form-data">
            <table class="add_tab">
                <tbody>
                    {{csrf_field()}}
                    <tr>
                    ...
                    <tr>
                        ...
                        <div class="cleditorMain" style="width: 500px; height: 250px;">
                           ...
                           <textarea class="cleditor" id="editor" name="art_content" style="display: none; width: 500px; height: 197px;"></textarea>
