...
@section('content')
		...
		<div class="box span12">
					<div class="box-header" data-original-title="">
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>动态添加</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="/admin/carousel" method="post" id="art_form" enctype="multipart/form-data">
							<fieldset>
							 {{ csrf_field() }}
							 ...
							 <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge focused" name="c_title">
							 ...
							 <div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge focused" name="c_editor" >
								<p class="help-block">这里是默认长度</p>
							  </div>
							</div>
							  <div class="control-group warning">
								<label class="control-label" for="inputWarning">缩略图：</label>
								<div class="controls">
								  <input type="file" id="c_pic" name="c_pic">
								  <span>选择后显示图片</span>
								  <div>
								  	<img src="" alt="" id="imgs" style="width:100px;height:100px;">
								  	<input type="text" id="c_path" name="c_path">
								  </div>
			            ...
			            $.ajax({
			                ...
			                error: function(XMLHttpRequest, textStatus, errorThrown) {
							  ...
							  <div class="control-group success">
								...
								<div class="controls">
								 	<textarea id="c_description" name="c_description"></textarea>
								 	<input type="hidden" name="c_time" value="{{date('Y-m-d H:i:s',time())}}">
								</div>
							  </div>
							  <div class="control-group success">
								<label class="control-label" for="inputSuccess">内容：</label>
								<div class="controls" style="width: 500px; height: 250px;">
									<textarea class="cleditor" id="editor" name="c_content" style="display: none; width: 500px; height: 197px;"></textarea>
